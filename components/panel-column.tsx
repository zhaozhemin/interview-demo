...
export function PanelColumn({ panel, onClose }: PanelColumnProps) {
  ...
  return (
    <section
      ...
      className={[
        "flex h-full min-w-[320px] flex-1 flex-col border-l border-[var(--line)] bg-white",
    ...
    >
      <header
        {...attributes}
        {...listeners}
        className="flex h-11 cursor-grab touch-none items-center justify-center border-b border-[var(--line)] bg-[var(--tab)] px-4 active:cursor-grabbing"
      >
